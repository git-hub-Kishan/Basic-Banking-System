...
<body>
                ...
                <ul class="navbar-nav me-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item dropdown py-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item py-3" href="money.php">View Customer</a></li>
    ...
    <class class="welcome">
        <h2>
            <strong>WELCOME TO SPARK BANK !!!</strong> </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/1.png" width="1000" height="600" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/2.jpg" width="1000" height="600" class="d-block w-100" alt="...">
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color:black">
                ...
                <a class="text-dark"><font color="white">Made by Kishan Singh for #Grip_November_2022</font></a>
            </div>
            <!-- Copyright -->
        </footer>
    </div>
